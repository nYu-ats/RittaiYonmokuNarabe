...
interface ICheckCanPutYIndex{
    int CheckCanPutYIndex(int xIndex, int zIndex);
}
public class Board : MonoBehaviour, IAddGo, ICheckCanPutYIndex
{
    ...
    public void AddGo(int xIndex, int zIndex, int addColor){
        int yIndex = CheckCanPutYIndex(xIndex, zIndex);
    ...
    public int CheckCanPutYIndex(int xIndex, int zIndex){
